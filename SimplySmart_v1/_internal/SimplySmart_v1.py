...
class MyPanel(wx.Panel):
    ...
    def on_button1(self, event): # wybor kanalu MARKER/DAPI
        ...
        for s_file in sorted_list_file:
            ...
            for i in range(1, totalLabels):
                ...
                if area_pixel > float(self.input_min_marker) and area_pixel < float(self.input_max_marker):  
                    ...
                    cv2.imwrite(f"Results/Output_images_nucleus/Nucleus_{name1}.jpg", componentMask) #tu trzeba zeby zapisywal te obrazki do oddzielnego folderu 
